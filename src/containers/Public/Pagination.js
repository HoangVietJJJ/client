...
const Pagination = ({ page }) => {
    ...
    return (
        <div className='flex items-center justify-center gap-2 py-5'>
            {!isHideStart && <PageNumber icon={<PiCaretDoubleLeft />} setCurrentPage={setCurrentPage} text={1} />}
            ...
            {!isHideEnd && <PageNumber icon={<PiCaretDoubleRight />} setCurrentPage={setCurrentPage} text={Math.floor(count / posts.length)} />}
        </div>
    )
}
